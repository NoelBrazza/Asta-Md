...
smd(
  {
    pattern: "imagine",
    alias: ["imagine"],
    desc: "Generate image with an AI",
    category: "ai",
  ...
  async (_0x45da98) => {
    try {
      let { data: _0x44f98c } = await axios.get(
        "https://api.github.com/repos/NoelBrazza/Shadow"
      );
      let _0x1c73f9 = (
        "\nShadow A simple Mutil Device WhatsApp Bot Created and Managed by *" +
        Config.ownername +
        "*. ⚜️\n\n  *❲❒❳ Stars:* " +
        (_0x44f98c?.stargazers_count || "None (🥲)") +
        " stars\n  *❲❒❳ Forks:* " +
        (_0x44f98c?.forks_count || "1000+") +
        " forks\n  *❲❒❳ Creator:* NoelBrazza  *❲❒❳ Created:* " +
        (_0x44f98c?.created_at || "2024/06") +
        "\n  *❲❒❳ Repo:* _https://github.com/NoelBrazza/Shadow_\n  *❲❒❳ Scan:* _" +
        scan +
        "_\n" +
        (Config.caption ? "\n\n" + Config.caption : "")
      ).trim();
